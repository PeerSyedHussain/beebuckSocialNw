...
$factory->define(\App\Domains\SubGroups\Models\SubGroup::class, function (Faker $faker) {
    return [
        'uuid' => $faker->uuid,
        'title' => $faker->company,
        ...
        'circle_id' => function () {
            return factory(\App\Domains\Circles\Models\Circle::class)->create()->id;
        },
        'group_id' => function () {
            return factory(\App\Domains\Groups\Models\Group::class)->create()->id;
        },
        'created_by' => function() {
