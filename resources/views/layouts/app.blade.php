        ...
        <div class='col-md-8'>
            <nav class='navbar navbar-dark bg-light'>
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a href="/users/1/about" class='nav-link'>About</a>
                    </li>
                    <!-- <li class="nav-item">
...
<div id="sidebar">
    <div class="toggle-btn" onclick="togglesidebar()">
        <img src='/img/beelogo.png' class='beelogo'>
